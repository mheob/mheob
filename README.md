...
1. 🎉 Merged PR [#533](https://github.com/mheob/itsb-web/pull/533) in [mheob/itsb-web](https://github.com/mheob/itsb-web)
2. 💪 Opened PR [#138](https://github.com/mheob/config/pull/138) in [mheob/config](https://github.com/mheob/config)
3. 🎉 Merged PR [#49](https://github.com/mheob/create-nextjs-components/pull/49) in [mheob/create-nextjs-components](https://github.com/mheob/create-nextjs-components)
4. 🎉 Merged PR [#532](https://github.com/mheob/itsb-web/pull/532) in [mheob/itsb-web](https://github.com/mheob/itsb-web)
5. 🚀 Published release [v2.1.0](https://github.com/mheob/vscode-snippets/releases/tag/v2.1.0) in [mheob/vscode-snippets](https://github.com/mheob/vscode-snippets)
